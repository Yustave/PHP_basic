...
$ary = ["yustave@localhost","lavan@localhost","kekki@localhost"];
// $to = implode(',',$ary);
// $subject = "Noxus Invasion";
// $message = "
//                 The war hunger Noxian crossed the Ionia's boderline. 
//                 THE WAR HAS BEGUN . 
//                 PEPRE Ionian . 
//                 Protect Your own soil .
//             ";
// $header = "From: ireliathebladedancer@gamil.com";
...
ST;
echo $message;
$header = "From: yustavelavan@gamil.com\r\n";
